          ...
          {searchResults && searchResults.length === 0 ? (
            ...
            currentPosts.map((post) => (
              <React.Fragment key={post?._id}>
                ...
                <Col className="mt-5" xs={4}>
                  <h1 style={{ wordBreak: "break-all" }} className="text-center">
                    {post?.title}
                  </h1>
                ...
                <Col className="mt-5 " xs={4}>
                  ...
                  {post?.star ? (
                    <Button   className="me-4 " variant="none" onClick={() => handleUnTag(post?._id)}>
                      {" "}
                      <IoPricetag />
                    </Button>
                  ) : (
                    <Button   className="me-4 " variant="none" onClick={() => handleTag(post?._id)}>
                      {" "}
                      <IoPricetagOutline />
                    </Button>
                  )}
